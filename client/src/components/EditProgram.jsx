...
import { useGetById,useUpdate,useDelete} from '../api/proApi';
...
export default function EditProgram() {
    ...
    return (
        ...
        {getProgram.data && <ProgramForm program={getProgram?.data} submitText="Edit" submitAction={onSubmit} />}    
            <StudentsList students={getProgram?.data?.students} headerInfo="List of Students that are part of this program" buttonLink={`/programs/addNewStudent/${getProgram?.data?._id}`} deleteFun={deleteFun}/>
        </>
